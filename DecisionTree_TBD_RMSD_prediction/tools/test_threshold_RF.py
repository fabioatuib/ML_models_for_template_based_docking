...
def test_threshold(train_test, maximum_depth, n_estimators, evaluation_thresholds, thresholds, binned_rmsd, not_features,
                   show_graphs=False):

    clf = RandomForestClassifier(max_depth=maximum_depth, n_estimators=n_estimators, class_weight="balanced")
